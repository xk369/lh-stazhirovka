...
test('trainee can withdraw a confirmed assignment before workgroup invite', () => {
...
test('trainee cannot withdraw someone else assignment or an invited application', () => {
